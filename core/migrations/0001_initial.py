# Generated by Django 5.0.14 on 2025-06-12 23:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(blank=True, help_text='Custom domain for this school (e.g., schoolname.edu.gh)', max_length=255, null=True, unique=True)),
                ('subdomain', models.CharField(blank=True, help_text="Subdomain for this school (e.g., 'schoolname' for schoolname.ttek.com)", max_length=100, null=True, unique=True)),
        ...
        migrations.AddConstraint(
            model_name='tenant',
            constraint=models.CheckConstraint(check=models.Q(('domain__isnull', True), ('subdomain__isnull', True), _negated=True), name='school_must_have_domain_or_subdomain'),
        ),
        migrations.AddField(
            model_name='teacher',
            name='school',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='core.tenant'),
        ),
        migrations.AddField(
            model_name='student',
            name='school',
